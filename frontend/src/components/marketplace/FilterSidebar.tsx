      ...
      >
        <div className="h-full flex flex-col">
          ...
          <div className="flex items-center justify-between px-4 py-3 border-b border-zinc-150 bg-white sticky top-0 z-10">
            <div className="flex items-center gap-1.5 font-serif text-sm font-bold text-[#1B5E3A]">
            ...
            <div className="flex items-center gap-4">
              <button
                onClick={onReset}
                className="text-[10px] font-bold text-zinc-500 hover:text-[#1B5E3A] uppercase tracking-wider underline underline-offset-2 transition-colors"
              >
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-5 custom-scrollbar bg-zinc-50/20">
            ...
            {activeTab === 'oil' ? (
              <>
                        ...
                        <button
                          ...
                          className={`py-1.5 px-2 rounded-lg border text-[11px] font-bold transition-all duration-200 ${
                            isSelected 
                              ...
                              : 'bg-white border-zinc-200 text-zinc-650 hover:border-[#1B5E3A]/30 hover:bg-[#1B5E3A]/5 hover:text-[#1B5E3A]'
                          }`}
                        >
                          {tier}
                        </button>
                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-1.5 text-zinc-800">
                    <Beaker className="w-3.5 h-3.5 text-[#1B5E3A]" />
                  ...
                  <div className="bg-white p-3 rounded-xl border border-zinc-150 shadow-sm">
                    ...
                    <div className="text-[9px] font-bold text-[#1B5E3A] bg-[#1B5E3A]/5 border border-[#1B5E3A]/10 rounded-md px-2 py-0.5 text-center mb-2.5">
                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-1.5 text-zinc-800">
                    <Archive className="w-3.5 h-3.5 text-[#1B5E3A]" />
                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-1.5 text-zinc-800">
                    <DollarSign className="w-3.5 h-3.5 text-[#1B5E3A]" />
                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-1.5 text-zinc-800">
                    <Factory className="w-3.5 h-3.5 text-[#1B5E3A]" />
                ...
                <div className="space-y-2 pt-1">
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      ...
                      className="text-[10px] font-bold text-[#1B5E3A] hover:text-valam-gold transition-colors flex items-center gap-0.5"
                    >
                          ...
                          <div className="flex items-center gap-2">
                            <div className={`w-3.5 h-3.5 rounded flex items-center justify-center border transition-all ${
                              isChecked 
                                ...
                                : 'bg-zinc-50 border-zinc-300 group-hover:border-[#1B5E3A]/50'
                            }`}>
                              {isChecked && <Check className="w-2.5 h-2.5 text-white" />}
                            </div>
                            <span className={`text-xs ${isChecked ? 'font-bold text-[#1B5E3A]' : 'text-zinc-655'}`}>
                              {district}
                            </span>
                          </div>
                ...
                <div className="space-y-2 pt-3 border-t border-zinc-200">
                  ...
                  {/* GC-MS Verified */}
                  <div 
                    className="cursor-pointer flex gap-2.5 items-start py-2 px-2.5 bg-white border border-zinc-150 hover:border-[#1B5E3A]/20 rounded-xl shadow-sm transition-all"
                  ...
                  >
                    <div className={`mt-0.5 flex-shrink-0 w-3.5 h-3.5 rounded flex items-center justify-center border transition-colors ${
                      filters.gcmsVerified ? 'bg-[#1B5E3A] text-white border-[#1B5E3A]' : 'bg-zinc-50 border-zinc-300'
                    }`}>
                      {filters.gcmsVerified && <Check className="w-2.5 h-2.5" />}
                    </div>
                    <div className="pl-0.5">
                      <h4 className={`text-xs font-bold ${filters.gcmsVerified ? 'text-[#1B5E3A]' : 'text-zinc-700'}`}>
                        GC-MS Verified
                      </h4>
                  ...
                  >
                    <div className={`mt-0.5 flex-shrink-0 w-3.5 h-3.5 rounded flex items-center justify-center border transition-colors ${
                      filters.coaOnly ? 'bg-[#1B5E3A] text-white border-[#1B5E3A]' : 'bg-zinc-50 border-zinc-300'
                    }`}>
                      {filters.coaOnly && <Check className="w-2.5 h-2.5" />}
                    </div>
                    <div className="pl-0.5">
                      <h4 className={`text-xs font-bold ${filters.coaOnly ? 'text-[#1B5E3A]' : 'text-zinc-700'}`}>
                        CoA Available
                      </h4>
                      <p className="text-[9px] text-zinc-450 mt-0.5 leading-tight">
                  ...
                  >
                    <div className={`mt-0.5 flex-shrink-0 w-3.5 h-3.5 rounded flex items-center justify-center border transition-colors ${
                      filters.qrTraceable ? 'bg-[#1B5E3A] text-white border-[#1B5E3A]' : 'bg-zinc-50 border-zinc-300'
                    }`}>
                      {filters.qrTraceable && <Check className="w-2.5 h-2.5" />}
                    </div>
                    <div className="pl-0.5">
                      <h4 className={`text-xs font-bold ${filters.qrTraceable ? 'text-[#1B5E3A]' : 'text-zinc-700'}`}>
                        QR Traceability
                      </h4>
                      <p className="text-[9px] text-zinc-450 mt-0.5 leading-tight">
                ...
                <div className="space-y-2 pt-3 border-t border-zinc-200">
                  ...
                  >
                    ...
                    <div className="pl-0.5">
                      <h4 className={`text-xs font-bold flex items-center gap-1 ${filters.eudrReady ? 'text-[#1B5E3A]' : 'text-zinc-700'}`}>
              ...
              <>
                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-1.5">
                    <Recycle className="w-3.5 h-3.5 text-[#1B5E3A]" />
                      ...
                      return (
                        <div 
                          ...
                          className={`cursor-pointer transition-all duration-200 rounded-lg border p-2.5 flex items-center justify-between ${
                            isSelected 
                              ? 'bg-[#1B5E3A] border-[#1B5E3A] text-white font-semibold' 
